...
```{r}
ris <- readLines("C:\\R\\riskoutbreak\\ref\\embase\\jul24\\ris.ris")
```
...
## Embase July 24 (2)
ris <- readLines("C:\\Users\\Admin\\Downloads\\ris (1).ris")
id <- paste0(1:3000, ". ")
nr <- which(ris %in% id)
l <- list()
...
## Embase Nov 23 (1)
ris <- readLines("C:\\Users\\Admin\\OneDrive\\Desktop\\Riskoutbreak\\ref-libs\\nov23\\Embase\\ro-embase-1.ris")
id <- paste0(1:2000, ". ")
nr <- which(ris %in% id)
l <- list()
